...
<html lang="fr">
  <head>
    ...
    <meta name="description" content="Je m'apelle Zao Soula, j'ai <?echo date(Y)-2002?> ans et je suis passionné d'informatique et d'electronique. Depuis maintenant <?echo date(Y)-2012?> ans je pratique le développement web, et maitrise aujourd'hui l'HTML, le PHP, le CSS et le Javascript.">
    ...
    <meta name="twitter:description" content="Je m'apelle Zao Soula, j'ai <?echo date(Y)-2002?> ans et je suis passionné d'informatique et d'electronique. Depuis maintenant <?echo date(Y)-2012?> ans je pratique le développement web, et maitrise aujourd'hui l'HTML, le PHP, le CSS et le Javascript.">
    ...
    <meta property="og:description" content="Je m'apelle Zao Soula, j'ai <?echo date(Y)-2002?> ans et je suis passionné d'informatique et d'electronique. Depuis maintenant <?echo date(Y)-2012?> ans je pratique le développement web, et maitrise aujourd'hui l'HTML, le PHP, le CSS et le Javascript.">
